...
import 'model/carolsel_parque.dart';


class ParqueContentWidget extends StatelessWidget {
  final double currentExplorePercent;
  const ParqueContentWidget({Key key, this.currentExplorePercent}) : super(key: key);
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Container(
        child: DestinationCarouselParque(),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Stack(
                            children: <Widget>[
                              Image.asset(
                                "assets/porto_alegre/parque/parque10.png",
                              ),
                              Positioned(
                                  bottom: realH(26),
                                  left: realW(24),
                          ...
                          Transform.translate(
                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/parque/parque20.png"),
                                ),
                                SizedBox(width: 10.0,),
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/parque/parque30.png"),
                                ),
                              ],
                            ),
                          )
