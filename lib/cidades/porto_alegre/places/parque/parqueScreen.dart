...
import 'package:travel_rs/cidades/porto_alegre/places/parque/parque_explored_widget.dart';
import 'package:travel_rs/cidades/porto_alegre/places/parque/parque_explorer.dart';
import 'package:travel_rs/cidades/porto_alegre/places/parque/parque_map_buttom.dart';
import 'package:travel_rs/cidades/porto_alegre/places/parque/parque_searche_widget.dart';
import 'package:travel_rs/citys_screen/porto_screen.dart';
import 'package:travel_rs/models/ui_helper.dart';

import 'parque_searche.dart';
import 'parquemenu.dart';


class ParqueScreen extends StatefulWidget {
  ParqueScreen();

  @override
  State<StatefulWidget> createState() {
    return _ParqueScreenState();
  }
}

class _ParqueScreenState extends State<ParqueScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/parque/parque.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            ParqueExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   ParqueContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              ParqueRecentWidget(
              currentSearchPercent: currentSearchPercent,
