...
import 'catedral_explored_widget.dart';
import 'catedral_explorer.dart';
import 'catedral_map_buttom.dart';
import 'catedral_play.dart';
import 'catedral_searche.dart';
import 'catedral_searche_widget.dart';
import 'catedralmenu.dart';


class CatedralScreen extends StatefulWidget {
  CatedralScreen();

  @override
  State<StatefulWidget> createState() {
    return _CatedralScreenState();
  }
}

class _CatedralScreenState extends State<CatedralScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/catedral/catedral.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            CatedralExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   CatedralContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              CatedralRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ),
