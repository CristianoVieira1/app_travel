...
class CatedralMaps extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CatedralMapsState();
}

class CatedralMapsState extends State<CatedralMaps> {
  final List<MapDestination> _destinations = [
    MapDestination("Catedral Metropolitana", _kLondonEye),
  ];
  ...
  static final CameraPosition _kLondonEye =
      CameraPosition(target: LatLng(-30.0335857, -51.2320576), zoom: 14.4746);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          color: Colors.white, onPressed: () {
            Navigator.of(context).pushReplacementNamed('/catedral');
          },
        ),
        actions: <Widget>[
          Container(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => MapsLauncher.launchCoordinates(
                    -30.0335857, -51.2320576, 'Orla do Guaiba'),
