...
import 'gremio_explored_widget.dart';
import 'gremio_explorer.dart';
import 'gremio_map_buttom.dart';
import 'gremio_menu.dart';
import 'gremio_searche.dart';
import 'gremio_searche_widget.dart';
...
class GremioScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _GremioScreenState();
  }
}

class _GremioScreenState extends State<GremioScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/gremio/gremio5.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            GremioExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   GremioContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              GremioRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ...
            //   GremioMapButton( /// buttom esquerda
            //   currentExplorePercent: currentExplorePercent,
            //   currentSearchPercent: currentSearchPercent,
            //   bottom: 243,
            //   offsetX: -71,
