...
import 'package:travel_rs/cidades/porto_alegre/places/quintana/quintana_map_buttom.dart';
import 'package:travel_rs/cidades/porto_alegre/places/quintana/quintana_searche_widget.dart';
import 'package:travel_rs/cidades/porto_alegre/places/quintana/quintanamenu.dart';
import 'package:travel_rs/citys_screen/porto_screen.dart';
import 'package:travel_rs/models/ui_helper.dart';

import 'quintana_explored_widget.dart';
import 'quintana_explorer.dart';
import 'quintana_searche.dart';


class QuintanaScreen extends StatefulWidget {
  QuintanaScreen();

  @override
  State<StatefulWidget> createState() {
    return _QuintanaScreenState();
  }
}

class _QuintanaScreenState extends State<QuintanaScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/quintana/mario.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            QuintanaExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   QuintanaContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              QuintanaRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ),
