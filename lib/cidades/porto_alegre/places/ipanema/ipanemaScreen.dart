...
import 'ipanema_explored_widget.dart';
import 'ipanema_explorer.dart';
import 'ipanema_map_buttom.dart';
import 'ipanema_play.dart';
import 'ipanema_searche.dart';
import 'ipanema_searche_widget.dart';
import 'ipanemamenu.dart';



class IpanemaScreen extends StatefulWidget {
  IpanemaScreen();

  @override
  State<StatefulWidget> createState() {
    return _IpanemaScreenState();
  }
}

class _IpanemaScreenState extends State<IpanemaScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/ipanema/ipanema.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            IpanemaExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   IpanemaContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              IpanemaRecentWidget(
              currentSearchPercent: currentSearchPercent,
