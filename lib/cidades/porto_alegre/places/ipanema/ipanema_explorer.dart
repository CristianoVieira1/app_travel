...
import 'package:travel_rs/cidades/porto_alegre/places/ipanema/model/carolsel_ipanema.dart';
import 'package:travel_rs/models/ui_helper.dart';


class IpanemaContentWidget extends StatelessWidget {
  final double currentExplorePercent;
  const IpanemaContentWidget({Key key, this.currentExplorePercent}) : super(key: key);
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
                    ...
                    Expanded(
                      child: Transform.translate(
                        offset: Offset(-screenWidth / 3 * (1 - currentExplorePercent),
                            screenWidth / 3 / 2 * (1 - currentExplorePercent)),
                        child: Image.asset(
                          "assets/porto_alegre/ipanema/jet.png",
                          width: realH(133),
                          height: realH(133),
                        ),
                      ),
              ...
              Container(
        child: DestinationCarouselIpanema(),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Stack(
                            children: <Widget>[
                              Image.asset(
                                "assets/porto_alegre/ipanema/barco.png",
                              ),
                              Positioned(
                                  bottom: realH(26),
                                  left: realW(24),
                          ...
                          Transform.translate(
                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/ipanema/ipanema20.png",),
                                ),
                                SizedBox(width: 10.0,),
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/ipanema/ipanema10.png"),
                                ),
                              ],
                            ),
                          )
