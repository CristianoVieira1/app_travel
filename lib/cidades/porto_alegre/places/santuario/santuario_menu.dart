...
class SantuarioMenuWidget extends StatelessWidget {
  final double currentSearchPercent;

  const SantuarioMenuWidget({Key key, this.currentSearchPercent}) : super(key: key);
        ...
        ? Positioned(
            ...
            child: Opacity(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      _buildSearchMenuItem(Icons.home, "Inicio"),
                      Padding(
                        padding: EdgeInsets.only(left: realW(16)),
                      ),
                      _buildSearchMenuItem(Icons.cancel, "Sair")
                    ],
                  ),
                )),
          )
