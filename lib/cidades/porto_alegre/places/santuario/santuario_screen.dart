...
import 'package:travel_rs/cidades/porto_alegre/places/santuario/santuario_explorer.dart';
import 'package:travel_rs/cidades/porto_alegre/places/santuario/santuario_explores_widget.dart';
import 'package:travel_rs/citys_screen/porto_screen.dart';
import 'package:travel_rs/models/ui_helper.dart';

import 'santuario_map_buttom.dart';
import 'santuario_menu.dart';
import 'santuario_play.dart';
import 'santuario_searche.dart';
import 'santuario_searche_widget.dart';
...
class SantuarioScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _SantuarioScreenState();
  }
}

class _SantuarioScreenState extends State<SantuarioScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/santuario/santuario.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            SantuarioExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   SantuarioContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              SantuarioRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ),
