...
import 'model/carolsel_belem.dart';

class BelemContentWidget extends StatelessWidget {
  final double currentExplorePercent;
  const BelemContentWidget({Key key, this.currentExplorePercent})
      : super(key: key);
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Transform.translate(
                        ...
                        child: Image.asset(
                          "assets/porto_alegre/belem/iconBelem1.png",
                          width: realH(133),
                          height: realH(133),
                        ),
                      ),
                    ...
                    Expanded(
                      child: Image.asset(
                        "assets/porto_alegre/belem/iconBelem2.png",
                        width: realH(133),
                        height: realH(133),
                      ),
                    ),
                    Expanded(
                      child: Transform.translate(
                        offset: Offset(
                            ...
                            screenWidth / 3 / 2 * (1 - currentExplorePercent)),
                        child: Image.asset(
                          "assets/porto_alegre/belem/iconBelem3.png",
                          width: realH(133),
                          height: realH(133),
                        ),
                      ),
              ...
              Container(
                child: DestinationCarouselBelem(),
              ),
              Transform.translate(
                  offset:
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Stack(
                            children: <Widget>[
                              Image.asset(
                                "assets/porto_alegre/belem/belem10.png",
                              ),
                              Positioned(
                                  bottom: realH(26),
                                  left: realW(24),
                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/belem/belem20.png",),
                                ),
                                SizedBox(width: 10.0,),
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/belem/belem30.png",),
                                ),
                              ],
                            ),
                          )
