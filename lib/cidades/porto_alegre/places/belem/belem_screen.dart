...
import 'belem_explorer.dart';
import 'belem_explores_widget.dart';
import 'belem_map_buttom.dart';
import 'belem_menu.dart';
import 'belem_play.dart';
import 'belem_searche.dart';
import 'belem_searche_widget.dart';


class BelemScreen extends StatefulWidget {
  BelemScreen();

  @override
  State<StatefulWidget> createState() {
    return _BelemScreenState();
  }
}

class _BelemScreenState extends State<BelemScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/belem/belem1.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            BelemExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   BelemContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              BelemRecentWidget(
              currentSearchPercent: currentSearchPercent,
