...
import 'package:travel_rs/cidades/porto_alegre/places/mercado/model/carolsel_mercado.dart';
import 'package:travel_rs/models/ui_helper.dart';


class MercadoContentWidget extends StatelessWidget {
  final double currentExplorePercent;
  const MercadoContentWidget({Key key, this.currentExplorePercent}) : super(key: key);
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Transform.translate(
                        ...
                        child: Image.asset(
                          "assets/porto_alegre/mercado/iconMercado1.png",
                          width: realH(133),
                          height: realH(133),
                        ),
                      ),
                    ...
                    Expanded(
                      child: Image.asset(
                        "assets/porto_alegre/mercado/iconMercado2.png",
                        width: realH(133),
                        height: realH(133),
                      ),
                    ),
                    Expanded(
                      child: Transform.translate(
                        offset: Offset(-screenWidth / 3 * (1 - currentExplorePercent),
                            screenWidth / 3 / 2 * (1 - currentExplorePercent)),
                        child: Image.asset(
                          "assets/porto_alegre/mercado/iconMercado3.png",
                          width: realH(133),
                          height: realH(133),
                        ),
                      ),
              ...
              Container(
        child: DestinationCarouselMercado(),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Stack(
                            children: <Widget>[
                              Image.asset(
                                "assets/porto_alegre/mercado/mercado10.png",
                              ),
                              Positioned(
                                  bottom: realH(26),
                                  left: realW(24),
                          ...
                          Transform.translate(
                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/mercado/mercado20.png",),
                                ),
                                SizedBox(width: 10.0,),
                                Expanded(
                                  child: Image.asset("assets/porto_alegre/mercado/mercado30.png",),
                                ),
                              ],
                            ),
                          )
