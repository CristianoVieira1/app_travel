...
class MercadoExploreWidget extends StatelessWidget {
                ...
                child: Stack(
                  children: [
                    Positioned(
                      ...
                      child: Text(
                        "Conheça",
                        style: TextStyle(color: Colors.black54, fontSize: realW(18 + (32 - 18) * currentExplorePercent)),
