...
import 'botanico_explored_widget.dart';
import 'botanico_explorer.dart';
import 'botanico_map_buttom.dart';
import 'botanico_menu.dart';
import 'botanico_play.dart';
import 'botanico_searche.dart';
import 'botanico_searche_widget.dart';

class BotanicoScreen extends StatefulWidget {
  BotanicoScreen();

  @override
  State<StatefulWidget> createState() {
    return _BotanicoScreenState();
  }
}

class _BotanicoScreenState extends State<BotanicoScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/botanico/botanico.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            BotanicoExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   BotanicoContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              BotanicoRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ),
