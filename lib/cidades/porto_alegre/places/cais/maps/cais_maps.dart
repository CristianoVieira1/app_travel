...
class CaisMaps extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CaisMapsState();
}

class CaisMapsState extends State<CaisMaps> {
  final List<MapDestination> _destinations = [
    MapDestination("Orla do Guaiba", _kLondonEye),
  ];
  ...
  static final CameraPosition _kLondonEye =
      CameraPosition(target: LatLng(-30.0334715, -51.2412795), zoom: 14.4746);
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => MapsLauncher.launchCoordinates(
                    -30.0334715, -51.2412795, 'Orla do Guaiba'),
