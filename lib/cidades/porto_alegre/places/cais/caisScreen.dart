...
import 'cais_explored_widget.dart';
import 'cais_explorer.dart';
import 'cais_map_buttom.dart';
import 'cais_play.dart';
import 'cais_searche.dart';
import 'cais_searche_widget.dart';
import 'caismenu.dart';

class CaisScreen extends StatefulWidget {
  CaisScreen();

  @override
  State<StatefulWidget> createState() {
    return _CaisScreenState();
  }
}

class _CaisScreenState extends State<CaisScreen> with TickerProviderStateMixin {
            ...
            CaisExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   CaisContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              CaisRecentWidget(
              currentSearchPercent: currentSearchPercent,
