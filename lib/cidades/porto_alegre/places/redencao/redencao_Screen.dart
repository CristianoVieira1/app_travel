...
import 'credencao_menu.dart';
import 'redencao_explored_widget.dart';
import 'redencao_explorer.dart';
import 'redencao_map_buttom.dart';
import 'redencao_play.dart';
import 'redencao_searche.dart';
import 'redencao_searche_widget.dart';

class RedencaoScreen extends StatefulWidget {
  RedencaoScreen();

  @override
  State<StatefulWidget> createState() {
    return _RedencaoScreenState();
  }
}

class _RedencaoScreenState extends State<RedencaoScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/redencao/redencao.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            RedencaoExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   RedencaoContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              RedencaoRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ),
