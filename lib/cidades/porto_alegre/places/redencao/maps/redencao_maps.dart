...
class RedencaoMaps extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => RedencaoMapsState();
}

class RedencaoMapsState extends State<RedencaoMaps> {
  final List<MapDestination> _destinations = [
    MapDestination("Redenção", _kLondonEye),
  ];
  ...
  static final CameraPosition _kLondonEye =
      CameraPosition(target: LatLng(-30.0384295, -51.2177305), zoom: 14.4746);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          color: Colors.white, onPressed: () {
            Navigator.of(context).pushReplacementNamed('/redencao');
          },
        ),
        actions: <Widget>[
          Container(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => MapsLauncher.launchCoordinates(
                    -30.0384295, -51.2177305, 'Redenção'),
