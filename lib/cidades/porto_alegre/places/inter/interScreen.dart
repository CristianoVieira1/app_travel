...
import 'inter_explored_widget.dart';
import 'inter_explorer.dart';
import 'inter_map_buttom.dart';
import 'inter_menu.dart';
import 'inter_searche.dart';
import 'inter_searche_widget.dart';
...
class InterScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _InterScreenState();
  }
}

class _InterScreenState extends State<InterScreen> with TickerProviderStateMixin {
        ...
        child: Stack(
          children: <Widget>[
            ...
            InterExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   InterContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              InterRecentWidget(
              currentSearchPercent: currentSearchPercent,
            ...
            InterSearchWidget(
              ...
              InterMapButton( /// buttom esquerda
              currentExplorePercent: currentExplorePercent,
              currentSearchPercent: currentSearchPercent,
              bottom: 243,
              offsetX: -71,
