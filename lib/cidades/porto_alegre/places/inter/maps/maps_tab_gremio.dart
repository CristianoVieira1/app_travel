...
class InterMaps extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => InterMapsState();
}

class InterMapsState extends State<InterMaps> {
  final List<MapDestination> _destinations = [
    MapDestination("Estádio Beira Rio", _kLondonEye),
  ];
  ...
  static final CameraPosition _kLondonEye =
      CameraPosition(target: LatLng(-30.0658308, -51.2365218), zoom: 14.4746);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          color: Colors.white, onPressed: () {
            Navigator.of(context).pushReplacementNamed('/inter');
          },
        ),
        actions: <Widget>[
          Container(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => MapsLauncher.launchCoordinates(
                    -30.0658308, -51.2365218, 'Estádio Beira Rio'),
