...
import 'moinhos_explored_widget.dart';
import 'moinhos_explorer.dart';
import 'moinhos_map_buttom.dart';
import 'moinhos_play.dart';
import 'moinhos_searche.dart';
import 'moinhos_searche_widget.dart';
import 'moinhosmenu.dart';



class MoinhosScreen extends StatefulWidget {
  MoinhosScreen();

  @override
  State<StatefulWidget> createState() {
    return _MoinhosScreenState();
  }
}

class _MoinhosScreenState extends State<MoinhosScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/moinhos/moinhos.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            MoinhosExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   MoinhosContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              MoinhosRecentWidget(
              currentSearchPercent: currentSearchPercent,
