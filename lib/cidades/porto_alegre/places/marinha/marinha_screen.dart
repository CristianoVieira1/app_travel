...
import 'marinha_explorer.dart';
import 'marinha_explores_widget.dart';
import 'marinha_map_buttom.dart';
import 'marinha_menu.dart';
import 'marinha_play.dart';
import 'marinha_searche.dart';
import 'marinha_searche_widget.dart';


class MarinhaScreen extends StatefulWidget {
  MarinhaScreen();

  @override
  State<StatefulWidget> createState() {
    return _MarinhaScreenState();
  }
}

class _MarinhaScreenState extends State<MarinhaScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/marinha/marinha.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            MarinhaExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   MarinhaContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              MarinhaRecentWidget(
              currentSearchPercent: currentSearchPercent,
