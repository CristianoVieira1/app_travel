...
import 'package:travel_rs/cidades/gramado/places/lago/lago_explorer.dart';
import 'package:travel_rs/citys_screen/porto_screen.dart';
import 'package:travel_rs/models/ui_helper.dart';

import 'lago_explored_widget.dart';
import 'lago_map_buttom.dart';
import 'lago_menu.dart';
import 'lago_play.dart';
import 'lago_searche.dart';
import 'lago_searche_widget.dart';



class LagoScreen extends StatefulWidget {
  LagoScreen();

  @override
  State<StatefulWidget> createState() {
    return _LagoScreenState();
  }
}

class _LagoScreenState extends State<LagoScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            Image.asset(
              "assets/porto_alegre/orla/orla.png",
              width: screenWidth,
              height: screenHeight,
              fit: BoxFit.cover,
            ),
            LagoExploreWidget(
              ...
              onPanDown: () => animationControllerExplore?.stop(),
                ...
                : const Padding(
                   ...
                   LagoContentWidget(///conteudo do explorer
              currentExplorePercent: currentExplorePercent,
            ),
              LagoRecentWidget(
              currentSearchPercent: currentSearchPercent,
