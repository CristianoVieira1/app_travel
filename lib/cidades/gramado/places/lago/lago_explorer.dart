...
import 'package:travel_rs/cidades/gramado/places/lago/model/carolsel_lago.dart';
import 'package:travel_rs/models/ui_helper.dart';


class LagoContentWidget extends StatelessWidget {
  final double currentExplorePercent;
  const LagoContentWidget({Key key, this.currentExplorePercent}) : super(key: key);
