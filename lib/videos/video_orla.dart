...
class VideoCais extends StatefulWidget {
  VideoCais({this.title = 'Orla do Guaiba'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoCaisState();
  }
}

class _VideoCaisState extends State<VideoCais> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => CaisScreen()),
