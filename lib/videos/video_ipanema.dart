...
class VideoIpanema extends StatefulWidget {
  VideoIpanema({this.title = 'Calçadão de Ipanema'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoIpanemaState();
  }
}

class _VideoIpanemaState extends State<VideoIpanema> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => IpanemaScreen()),
