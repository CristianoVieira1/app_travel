...
class VideoMoinhos extends StatefulWidget {
  VideoMoinhos({this.title = 'Parcão'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoMoinhosState();
  }
}

class _VideoMoinhosState extends State<VideoMoinhos> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => MoinhosScreen()),
