...
class VideoGramado extends StatefulWidget {
  VideoGramado({this.title = 'Gramado'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoGramadoState();
  }
}

class _VideoGramadoState extends State<VideoGramado> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => GramadoScreen()),
