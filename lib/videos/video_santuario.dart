...
class VideoSantuario extends StatefulWidget {
  VideoSantuario({this.title = 'Santuario'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoSantuarioState();
  }
}

class _VideoSantuarioState extends State<VideoSantuario> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => SantuarioScreen()),
