...
class VideoBotanico extends StatefulWidget {
  VideoBotanico({this.title = 'Jardim Botânico'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoBotanicoState();
  }
}

class _VideoBotanicoState extends State<VideoBotanico> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => BotanicoScreen()),
