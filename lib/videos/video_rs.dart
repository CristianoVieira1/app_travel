...
class VideoRs extends StatefulWidget {
  VideoRs({this.title = 'Rio Grande do Sul'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoRsState();
  }
}

class _VideoRsState extends State<VideoRs> {
