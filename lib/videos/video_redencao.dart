...
class VideoRedencao extends StatefulWidget {
  VideoRedencao({this.title = 'Parque da Redenção'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoRedencaoState();
  }
}

class _VideoRedencaoState extends State<VideoRedencao> {
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              ...
              context,
              MaterialPageRoute(
                  builder: (BuildContext context) => RedencaoScreen()),
