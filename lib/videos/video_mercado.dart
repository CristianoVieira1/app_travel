...
class VideoMercado extends StatefulWidget {
  VideoMercado({this.title = 'Praia do Veludo'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _VideoMercadoState();
  }
}

class _VideoMercadoState extends State<VideoMercado> {
          ...
          leading: IconButton(
            ...
            color: Colors.white, onPressed: () {
              Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (BuildContext context) => MercadoScreen()),
